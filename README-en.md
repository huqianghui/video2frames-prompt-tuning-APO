...
> [doc/en-us/optimization-stages.md](doc/en-us/optimization-stages.md) to locate which
...
[doc/en-us/dataset-sizing.md](doc/en-us/dataset-sizing.md) for how to estimate the split
...
grow the splits per [doc/en-us/dataset-sizing.md](doc/en-us/dataset-sizing.md) and
re-verify first.
...
are logged in [doc/en-us/reward-comparison.md](doc/en-us/reward-comparison.md).
...
See [doc/en-us/reward-design.md](doc/en-us/reward-design.md) for the v1 design rationale
...
[doc/en-us/apo-poml-customization.md](doc/en-us/apo-poml-customization.md) for what the two
...
See [doc/en-us/performance-tuning.md](doc/en-us/performance-tuning.md) for what the beam
...
See [doc/en-us/dashboard.md](doc/en-us/dashboard.md) for details, including why the
...
| `doc/en-us/optimization-stages.md` / `doc/optimization-stages.md` | **Start-here strategy guide**: the model/data/prompt levers, how to locate your current optimization stage from reward components, and the stage-by-stage roadmap with exit/termination criteria (English/Chinese). |
| `doc/en-us/dataset-sizing.md` / `doc/dataset-sizing.md` | Guide for sizing the splits (noise/SE math), staged scaling, and beam-hyperparameter tuning playbook (English/Chinese). |
| `doc/en-us/reward-design.md` / `doc/reward-design.md` | Reward definition, design rationale, and the open questions to confirm with the customer (English/Chinese). |
| `doc/en-us/reward-comparison.md` / `doc/reward-comparison.md` | Measured v1-vs-v2 comparison log: baseline scale calibration on the test split, interpretation, and the 2×2 end-to-end comparison playbook (English/Chinese). |
| `doc/en-us/apo-poml-customization.md` / `doc/apo-poml-customization.md` | What the APO meta-prompts do, why they are customized, and the exact changes vs the framework defaults (English/Chinese). |
| `doc/en-us/dashboard.md` / `doc/dashboard.md` | What the Agent-Lightning dashboard is, why the "Dashboard directory not found" error is harmless, and how to build/access the UI (English/Chinese). |
| `doc/en-us/performance-tuning.md` / `doc/performance-tuning.md` | Beam hyperparameters (rounds/width/branch-factor) with a tuning decision table, concurrency model, run-time/quota formulas, and how to choose `--n-runners` and batch sizes (English/Chinese). |
| `README-en.md` / `README.md` | This document (English/Chinese). |
